...
: ${AMENT_CURRENT_PREFIX:="/home/ws/tests/ws/install/table"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/table/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/table/environment/path.sh"
